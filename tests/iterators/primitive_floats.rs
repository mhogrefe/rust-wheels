    ...
    T::UnsignedOfEqualWidth: From<Integer>,
{
    eo.match_vec(
        ...
        &mut exhaustive_positive_ordinary_primitive_floats::<T>(),
    );
}

#[test]
fn test_exhaustive_positive_ordinary_primitive_floats() {
    let eo = get_expected_test_outputs();
    exhaustive_positive_ordinary_primitive_floats_helper::<f32>(&eo);
    ...
    T::UnsignedOfEqualWidth: From<Integer>,
{
    eo.match_vec(
        ...
        &mut exhaustive_negative_ordinary_primitive_floats::<T>(),
    );
}

#[test]
fn test_exhaustive_negative_ordinary_primitive_floats() {
    let eo = get_expected_test_outputs();
    exhaustive_negative_ordinary_primitive_floats_helper::<f32>(&eo);
    ...
    T::UnsignedOfEqualWidth: From<Integer>,
{
    eo.match_vec(
        ...
        &mut exhaustive_nonzero_ordinary_primitive_floats::<T>(),
    );
}

#[test]
fn test_exhaustive_nonzero_ordinary_primitive_floats() {
    let eo = get_expected_test_outputs();
    exhaustive_nonzero_ordinary_primitive_floats_helper::<f32>(&eo);

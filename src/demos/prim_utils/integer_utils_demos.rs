...
demo_bits!("i8", demo_bits_i8, natural_i8s);
demo_bits!("i16", demo_bits_i16, natural_i16s);
demo_bits!("i32", demo_bits_i32, natural_i32s);
demo_bits!("i64", demo_bits_i64, natural_i64s);
demo_bits!("isize", demo_bits_isize, natural_isizes);
